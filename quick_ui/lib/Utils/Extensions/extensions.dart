...
extension PaddingExtension on Widget {
  ...
  Widget padSymmetric(double value, double anotherValue) =>
...
extension GestureExtension on Widget {
  Widget onTapped({required void Function() onTap, HitTestBehavior? hitBehaviour}) => GestureDetector(
    behavior: hitBehaviour,
        onTap: onTap,
